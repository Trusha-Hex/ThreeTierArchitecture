#pragma checksum "E:\Trusha\Training\ThreeTierApp\ThreeTierApp.Web\Views\Task\Index.cshtml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "76bb8d1a0692ecad977b54964cc88dc79e5c04127f62e7a562bccf38fe046f12"
// <auto-generated/>
...
namespace AspNetCoreGeneratedDocument
{
    ...
    #line default
    #line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"Sha256", @"76bb8d1a0692ecad977b54964cc88dc79e5c04127f62e7a562bccf38fe046f12", @"/Views/Task/Index.cshtml")]
    #nullable restore
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "76bb8d1a0692ecad977b54964cc88dc79e5c04127f62e7a562bccf38fe046f123547", async() => {
                WriteLiteral(@"
    <meta charset=""UTF-8"">
...
");
            ...
            WriteLiteral("\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "76bb8d1a0692ecad977b54964cc88dc79e5c04127f62e7a562bccf38fe046f127133", async() => {
                WriteLiteral(@"
   ...
   ");
                WriteLiteral(@"                         <td>
                                ...
                                <button ng-if=""isDueDatePassed(task)"" ng-click=""sendReminder(task)"" class=""btn btn-sm btn-secondary"">Reminder</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
    ...
    <div id=""taskModal"" class=""modal"" tabindex=""-1"">
        <div class=""modal-dialog"">
            <div class=""modal-content"">
             ...
             ");
                WriteLiteral(@"       <button type=""button"" class=""close"" ng-click=""closeTaskModal()"" aria-label=""Close"">
                        <span aria-hidden=""true"">&times;</span>
                    </button>
                </div>
                ...
                WriteLiteral(@"""form-label"">Assigned To</label>
                        ...
                        <div class=""mb-3"">
                            ...
                            <div class=""form-check form-switch"">
                                <input type=""checkbox"" class=""form-check-input"" ng-model=""task.isCompleted"" ng-change=""toggleTaskStatus(task)"" />
                                <label class=""form-check-label"" for=""status"">{{task.isComp");
                WriteLiteral(@"leted ? 'Completed' : 'Pending'}}</label>
                            </div>
                        </div>
                    </form>
                </div>
  ...
  ");
                ...
                $");
                WriteLiteral(@"scope.loadEmployees = function () {
                ...
                $scope.closeNotification = function () {
                 ...
                 $scope.viewAssignedEmployees = function (task) {
                    ...
                    task.assignedEmployeeIds.forEach(function (employeeId) {
                        $http.get('https://localhost:65391/emp");
                WriteLiteral(@"loyees/' + employeeId)  // Fetch employee by ID
                            .then(function (response) {
    ...
    ");
          ...
          ");
                WriteLiteral(@"  // Set method and URL based on whether task ID exists
            ...
            if (confirm('Are you sure you want to delete this task?'");
                ...
                $http.delete('/tasks/' + taskId)  // Use the appropriate delete API endpoint
                    .then(function (response) {
                        $scope.showNotification('Task deleted successfully!');
        ...
        $scope.isDueDatePassed = function (task) {
        ...
        $scope.sendReminder = function (task) {
            ...
            const url = `https://localhost:65391/tasks/send-overdue-notification/${task.id}`;

         ");
                WriteLiteral(@"   // Make an HTTP POST request to the API
            $http.post(url)
                .then(function (response) {
                ...
                .catch(function (error) {
                    ...
                    if (error.data) {
                        $scope.showNotification(error.data.notification || 'Failed to send reminder email.');
                    } else {
                        $scope.showNotification('Failed to send reminder email.');
                    }
                });
        };
