#pragma checksum "E:\Trusha\Training\ThreeTierApp\ThreeTierApp.Web\Views\Employee\Index.cshtml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "3d70721bcb0fc235035b25cb2a34b8bdd1948d624cdd96cf630a9f305aefc090"
// <auto-generated/>
...
namespace AspNetCoreGeneratedDocument
{
    ...
    #line default
    #line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"Sha256", @"3d70721bcb0fc235035b25cb2a34b8bdd1948d624cdd96cf630a9f305aefc090", @"/Views/Employee/Index.cshtml")]
    #nullable restore
...
#nullable disable
            ...
            WriteLiteral("\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "3d70721bcb0fc235035b25cb2a34b8bdd1948d624cdd96cf630a9f305aefc0903116", async() => {
                WriteLiteral(@"
    <meta charset=""UTF-8"">
...
");
            ...
            WriteLiteral("\r\n\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "3d70721bcb0fc235035b25cb2a34b8bdd1948d624cdd96cf630a9f305aefc09010275", async() => {
                WriteLiteral(@"
            ...
            ");
                ...
                <div class=""modal-footer"">
                    ...
                    <div class=""ml-auto"">
                        ...
                        <button type=""button"" id=""update-btn"" class=""btn btn-warning"" style=""display: none;"">Update E");
                WriteLiteral(@"mployee</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        //                     <input class=""form-check-input"" type=""checkbox"" id=""active-toggle-${employee.id}"" ${employee.isActive ? 'checked' :");
                WriteLiteral(@" ''} onchange=""toggleActive(${employee.id}, this)"">
        //                 </div>`,
                    ...
                    render: function(data, type, row) {
                        return `
                            <button class=""btn btn-warning"" onclick=""editEmployee(${row.id})"">
                                <i clas");
                WriteLiteral(@"s=""fas fa-edit""></i>
                            </button>
                            <button class=""btn btn-danger"" onclick=""deleteEmployee(${row.id})"">
                                <i class=""fas fa-trash""></i>
                            </button>
                            <button class=""btn btn-primary btn-sm"" data-bs-toggle=""modal"" data-bs-target=""#tasksModal"" onclick=""setEmployeeIdForTasks(${row.id})"">
                                Tasks Assigned
                            </button>
                        `;
                    }
        ...
        function toggleActive(employeeId, toggle) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    console.log(`Employee ${employeeId} is now");
                WriteLiteral(@" ${isActive ? 'active' : 'inactive'}`);
        ...
        function showAlert(type, message) {
            ...
            setTimeout(() =>");
                WriteLiteral(@" alertBox.fadeOut(), 3000);
        }
        ...
        $(""#add-btn"").click(function () {
            ...
            if (isValid) {
                const employee = {
                    ...
                    email,
                    pa");
                WriteLiteral(@"sswordHash: password, // Store hashed password
                    department,
                    salary,
                    role,
                };
            ...
            if (isValid) {
                ...
                $.ajax({
                    ...
                    success: function () {
                        ...
                        $(""#update-btn"").hide();
                        $(""#employeeModal"").modal(""hide""); // Close the modal
                        showAlert(""success"", ""Employee updated successfully!""); // Success alert
                    },
                    error: function (xhr) {
                        const errorMessage = xhr.responseJSON?.message || ""Failed to");
        ...
        // Delete employee
   ");
                WriteLiteral(@"     function deleteEmployee(id) {
           ...
           function setEmployeeIdForTasks(employeeId) {
            console.log(""Employee ID being set");
        ...
        // Show error message
");
                WriteLiteral(@"        function showError(message) {
            $(""#alert-message"").text(message);
