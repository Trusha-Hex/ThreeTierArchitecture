#pragma checksum "E:\Trusha\Training\ThreeTierApp\ThreeTierApp.Web\Views\Employee\Index.cshtml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "fed2cf03049649ab9853e9e59a5140886e23bae0cfdfdb326b3f056cb50dd1a4"
// <auto-generated/>
...
namespace AspNetCoreGeneratedDocument
{
    ...
    #line default
    #line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"Sha256", @"fed2cf03049649ab9853e9e59a5140886e23bae0cfdfdb326b3f056cb50dd1a4", @"/Views/Employee/Index.cshtml")]
    #nullable restore
...
#nullable disable
            ...
            WriteLiteral("\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "fed2cf03049649ab9853e9e59a5140886e23bae0cfdfdb326b3f056cb50dd1a43116", async() => {
                WriteLiteral(@"
    <meta charset=""UTF-8"">
...
");
            ...
            WriteLiteral("\r\n\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "fed2cf03049649ab9853e9e59a5140886e23bae0cfdfdb326b3f056cb50dd1a410275", async() => {
                WriteLiteral(@"
                ...
                data.forEach(employee => {
                    employeesTable.row.add([
                        ...
                        `<div class=""form-check form-switch"">
                            <input class=""form-check-input"" type=""checkbox"" id=""active-toggle-${employee.id}"" ${employee.isActive ? 'checked' : ''} onchange=""toggleActive(${employee.id");
                WriteLiteral(@"}, this)"">
                        </div>`,
    ...
    ");
        ...
        function showAlert(type, message) {
            ...
            console.");
                WriteLiteral(@"log(`Showing ${type} alert:`, message); 
            alertBox.fadeIn(); 
            ...
            if (!name || !username || !email || !password || !department || isNaN(salary) || salary <= 0) {
                ...
                isValid = false;
                $(""#error-message"").text(""All fields are required and salary must b");
                WriteLiteral(@"e greater than 0."").show();
            }
        ...
        $(""#update-btn"").click(function() {
            ...
            if (!name || !username || !email || !password || !department || isNaN(salary) || salary");
                WriteLiteral(@" <= 0) {
                isValid = false;
            ...
            if (isValid) {
                ...
                WriteLiteral(@"  $(""#update-btn"").hide();
                    ...
                    error: function(xhr) {
                        ...
                        showAlert('danger', errorMessage); // Show error message for update
                    }
                });
            }
        });
        ...
        function editEmployee(id) {
            $.get(`${apiBaseUrl}/${id}`, function(employee) {
                ...
                $(""#employee-department"").val(empl");
                WriteLiteral(@"oyee.department);
            ...
            if (confirm(""Are you sure you want to delete this employee?"")) {
                $.ajax({
                    ...
                    error: function(xhr) {
                        ...
                        showAlert('dang");
                WriteLiteral(@"er', errorMessage); // Show error message
                    }
                });
            }
        }
        ...
        function fetchAssignedTasks(employeeId) {
            $.get(`https://localhost:65391/employees/${employeeId}/tasks`, function(tasks) {
                ...
                if (tasks && tasks.length > 0) {
                    ...
                    tasksList.append('<li>No tasks");
                WriteLiteral(@" assigned.</li>');
                }
            });
        }
      ...
      ");
                WriteLiteral(@"  function showSuccess(message) {
